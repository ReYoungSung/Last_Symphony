...
namespace Leap.Unity
{
    ...
    public class ExtendedFingerDetector : Detector
    {
        ...
        public bool ThumbExtended = false;
        public bool IndexExtended = false;
        public bool MiddleExtended = false;
        public bool RingExtended = false;
        public bool PinkyExtended = false;
                ...
                if (HandModel != null && HandModel.IsTracked)
                {
                    ...
                    if (hand != null)
                    {
                        ...
                        for (int f = 0; f < 5; f++)
                        {
                            ...
                            {
                                extendedCount++;
                                if (f == 0) ThumbExtended = true;
                                else if(f == 1) IndexExtended = true;
                                else if (f == 2) MiddleExtended = true;
                                else if (f == 3) RingExtended = true;
                                else PinkyExtended = true;
                            }
                            else
                            {
                                if (f == 0) ThumbExtended = false;
                                else if (f == 1) IndexExtended = false;
                                else if (f == 2) MiddleExtended = false;
                                else if (f == 3) RingExtended = false;
                                else PinkyExtended = false;
                            }
                        }
